...
//------------------- ajax -----------------------
	...
	function ajaxValidate (){
		$.ajax({
		    ...
		    url: SPS_QUEUE_VALIDATE,//ref:  /bms/js/service.js
		    data: {
		    ...
		    success: function(response){
			    if (response.success){
		    		...
		    		var data = response.data;
		    	 	$('#infoSeries').html(byd.SeriesName[data.series]);
	...
	function ajaxEnter(toPrint){
		...
		$.ajax({
			type: "get",//使用get方法访问后台
        	dataType: "json",//返回json格式的数据
			url: SPS_QUEUE_SUBMIT,//ref:  /bms/js/service.js
			data: {
				"vin": $('#vinText').attr("value"),
				"point" : $("#spsPoint").val(),
			},
	...
	//get the car orig
	function ajaxGetQueueList(){
		$.ajax({
		    type: "get",//使用get方法访问后台
    	    dataType: "json",//返回json格式的数据
		    url: SPS_QUEUE_QUERY,//ref:  /bms/js/service.js
		    data: {
		    	"point": $("#spsPoint").val(),
		    	"stime":$("#startTime").val(),
				"etime":$("#endTime").val(),
