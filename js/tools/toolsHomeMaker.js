$(document).ready(function() {
    ...
    $("#tableToolsList").live("click", function(e) {
        if ($(e.target).html() === "编辑") {
            ...
            $("#textEditMaker").val(siblings[1].innerHTML);
            $("#textEditDisplayName").val(siblings[2].innerHTML);
            $("#textEditBrand").val(siblings[3].innerHTML);
    ...
    $("#btnAddConfirm").click(function() {
        if ($("#textAddBrand").val() == '' || $("#textAddMaker").val() == '') {
            alert('品牌或制造商为空');
            return false;
        }
        ajaxAdd();
    ...
    $("#btnEditConfirm").click(function() {
        if ($("#textEditBrand").val() == '' || $("#textEditMaker").val() == '') {
            alert('品牌或制造商为空');
            return false;
        }
        ajaxEdit();
    ...
    function ajaxAdd() {
        $.ajax({
            ...
            data: {
                "type": 'adds',
                "brand": $("#textAddBrand").val(),
                "maker": $("#textAddMaker").val(),
    ...
    function ajaxEdit() {
        $.ajax({
            ...
            data: {
                ...
                "brand": $("#textEditBrand").val(),
                "maker": $("#textEditMaker").val(),
