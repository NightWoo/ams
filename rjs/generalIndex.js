...
require(["dateTimeUtil","head","service","common","jquery","bootstrap"], function(dateTimeUtil,head,service,common,$) {
	...
	tumbnailUrl = {
		...
		"planningDivisionFourTech": "/bms/execution/report?type=PlanningDivisionFourTech",
		"planningDivisionNewOrder": "/bms/execution/report?type=PlanningDivisionNewOrder",
		"planningDivisionSalesVolume": "/bms/execution/report?type=PlanningDivisionSalesVolume",
