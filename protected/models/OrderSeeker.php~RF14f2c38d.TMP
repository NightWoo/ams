...
class OrderSeeker
{
    ...
    public function getOriginalOrders($orderNumber) {
        ...
        foreach($orders as &$order){
            ...
            //  $order['series'] = '6B';
            // }
            $order['series'] = $seriesCodeList[$order['series']];
    ...
    public function getSellOrderDetail($orderDetailId) {
        ...
        $order = Yii::app()->dbCRM->createCommand($sql)->queryRow();
    ...
    public function getLaneList() {
        $sql = "SELECT id, name FROM lane WHERE disabled=0";
