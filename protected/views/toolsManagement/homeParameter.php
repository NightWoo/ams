...
<html lang="en">
    <head>
        ...
        <script type="text/javascript" src="/bms/js/tools/toolsHomeParameter.js"></script>        
                ...
                <div><!-- 主体 -->
                    <div id="divTabs">
                        <ul id="tabs" class="nav nav-pills">
                            ...
                            <li class="active"><a href="/bms/toolsManagement/homeParameter">参数单位</a></li>
                    ...
                    <form id="form" class="well form-search">
                        <table border="0" cellspacing="0" cellpadding="3">
                            ...
                            <tr>
                                ...
                                <td>
                                    <input type="text" class="input-large" id="parameter" style="height: 20px" value="" style="height: 20px" data-provide="typeahead" data-items="4" data-source="<?php echo $promptData;?>">
                                </td>
                                <td>
            ...
            <div class="modal-body">
                <form id="" class="form-horizontal">
                    <div class="control-group">
                        <label class="control-label" for="">参数名</label>
                        <div class="controls">
                            <input type="text" class="input-medium" id="textAddParameter" style="height: 20px">
                        </div>
                    </div>
                    <div class="control-group">
                        <label class="control-label" for="">单位</label>
                        <div class="controls">
                            <input type="text" class="input-medium" id="textAddUnit" style="height: 20px">
                        </div>
                    </div>         
                </form>
            </div>
            ...
            <div class="modal-body">
                <form id="" class="form-horizontal">
                    <div class="control-group">
                        <label class="control-label" for="">参数名</label>
                        <div class="controls">
                            <input type="text" class="input-medium" id="textEditParameter" style="height: 20px">
                        </div>
                    </div>
                    <div class="control-group">
                        <label class="control-label" for="">单位</label>
                        <div class="controls">
                            <input type="text" class="input-medium" id="textEditUnit" style="height: 20px">
                        </div>
                    </div>   
                    <div class="control-group">
