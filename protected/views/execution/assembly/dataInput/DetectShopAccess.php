					...
					<div>
						<form id="formFailure" class="well form-search">
							<div>
								...
								<button id="btnLeave" type="submit" class="btn btn-danger" disalbled='disabled' name='DETECT_SHOP_LEAVE'>离开</button>
								<button id="btnReturn" type="submit" class="btn btn-danger" disalbled='disabled' name='DETECT_SHOP_RETURN'>归还</button>
