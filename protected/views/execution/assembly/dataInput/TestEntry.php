...
<html lang="en">
	...
	<link href="/bms/css/execution/assembly/dataInput/TestEntry.css" rel="stylesheet">
	<link href="/bms/css/common.css" rel="stylesheet">
    <script type="text/javascript" src="/bms/js/jquery-1.8.0.min.js"></script>
	<script type="text/javascript" src="/bms/js/service.js"></script>
    <script type="text/javascript" src="/bms/js/bootstrap.min.js"></script>
    <script type="text/javascript" src="/bms/js/head.js"></script>
    <script type="text/javascript" src="/bms/js/execution/assembly/dataInput/testEntry.js"></script>
	</head>
	<body>
		<?php
				...
				<div ><!-- 内容主体 -->
					<form id="form" class="well form-search">
						...
						<input type="button" class="btn btn-primary" disabled="disabled" 
							id ="btnSubmit" value ="进检测车间"></input>
