...
<head>
    ...
    <title></title>
    <style type="text/css">
        td{border:1px solid black;font-size: 8px;font-family: "宋体"}
        thead{padding: 0;margin: 0;border:none;}
        thead td{border:none;}
    </style>
</head>
<body>
    <div>
    <img src="x.png" alt="" style="position:absolute;bottom:25px;left:270px">
    <table class="table-custom" style='border-collapse:collapse;width:297mm;heigh:208mm;'>
       <!--  <thead style="display:none;"> -->
        ...
        <tbody>
            <tr height="17px">
                ...
                <td colspan="4" rowspan="2" style="text-align:right;border:none;font-size:18px;font-weight:bold;">F0 整 车 检 验 单</td>
            ...
            <tr height="13px">
                <td colspan="21" style="font-weight:bold;">措施：不良…×；返修…R；更换…G；确认…     &nbsp;;未录QMS系统…△</td>
            </tr>
            <tr height="13px">
