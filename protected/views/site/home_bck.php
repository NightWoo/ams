...
<body>
	...
	<div id="tileContainer" class="floatClear">
		...
		<div id="manufactureReport" class="tile square">
			<div class="title">
				<h3>生产报表</h3>
			</div>
		</div>
		
		<div id="warehouseMaintain" class="tile square shortcut">
			<div class="title">
				<h3>成品库<br>维护</h3>
			</div>
		</div>
		...
		<div id="qualtityReport" class="tile square">
			<div class="title">
				<h3>质量报表</h3>
			</div>
		</div>
		...
		<div id="maintain" class="tile square shortcut">
			<div class="title">
				<h3>总装维护</h3>
			</div>
		</div>
