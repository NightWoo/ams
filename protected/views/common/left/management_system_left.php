...
<div id="bodyleft" class="span2"><!-- 侧边栏 -->
	<ul class="nav nav-list affix">
		...
		<li class="nav-header" id="leftManualLi">管理手册</li>
			<li id="leftOverviewLi"><a href="/bms/ManagementSystem/home?chapter=0">概述</a></li>
			<li id="leftPolicyLi"><a href="/bms/ManagementSystem/home?chapter=10">方针与愿景</a></li>
			<li id="leftGoalLi"><a href="/bms/ManagementSystem/home?chapter=13">管理目标</a></li>
			<li id=""><a>八大原则</a></li>
			<li id="leftStructureLi"><a href="/bms/ManagementSystem/home?chapter=21">组织结构与职责</a></li>
			<li id="leftProcessLi"><a href="/bms/ManagementSystem/home?chapter=22">管理过程</a></li>
