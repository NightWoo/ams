      ...
      ?>
			<div id="bodyright" class="offset2"><!-- Main -->				
				...
				<div class="main"><!-- 内容主体 -->
                  ...
                  <?php 
                    $dir='/home/work/bms/web/bms/doc/browse/managementSystem/quality/controllLoop';  
                    $handle=opendir($dir);  
                    $i=0;  
                    ...
                    for($n=1;$n<=$i;$n++){
                      ...
                      echo '<img src="/bms/doc/browse/managementSystem/quality/controllLoop/'. $n .'.JPG" alt="">';
                      echo '<div class="carousel-caption">';
                      echo '<p class="pull-right"><a href="/bms/doc/ppt/controllLoop.pptx"><i class="icon-download-alt icon-white"></i>下载该文档</a></p>';
                      echo '<h4>质量控制环</h4>';
                      echo '<p></p>';
                      echo '</div>';
                      echo '</div>';
