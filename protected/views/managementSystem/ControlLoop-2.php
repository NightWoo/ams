      ...
      ?>
			<div id="bodyright" class="offset2"><!-- Main -->				
				...
				<div class="main"><!-- 内容主体 -->
                  ...
                  <?php 
                    $dir='/home/work/bms/web/bms/doc/browse/managementSystem/quality/AMS-Q-P3.2_ControlLoop-2';  
                    $handle=opendir($dir);  
                    $i=0;  
                    ...
                    for($n=1;$n<=$i;$n++){
                      ...
                      echo '<img src="/bms/doc/browse/managementSystem/quality/AMS-Q-P3.2_ControlLoop-2/'. $n .'.JPG" alt="">';
                      echo '<div class="marsking"></div>';
                      echo '<div class="carousel-caption">';
                      echo '<p class="pull-right"><a href="/bms/doc/ppt/AMS-Q-P3.2_ControlLoop-2.pptx"><i class="icon-download-alt icon-white"></i>下载该文档</a></p>';
                      echo '<h4>质量控制环</h4>';
                      echo '<p></p>';
                      echo '</div>';
                      echo '</div>';
