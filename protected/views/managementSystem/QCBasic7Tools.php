      ...
      ?>
			<div id="bodyright" class="offset2"><!-- Main -->
				...
				<div class="main"><!-- 内容主体 -->
                  ...
                  <?php
                    $dir='/home/work/bms/web/bms/doc/browse/managementSystem/quality/QCBasic7Tools';
                    $handle=opendir($dir);
                    $i=0;
                    ...
                    for($n=1;$n<=$i;$n++){
                      ...
                      echo '<img src="/bms/doc/browse/managementSystem/quality/QCBasic7Tools/'. $n .'.JPG" alt="">';
                      echo '<div class="marsking"></div>';
                      echo '<div class="carousel-caption">';
                      echo '<p class="pull-right"><a href="/bms/doc/ppt/QCBasic7Tools.pptx"><i class="icon-download-alt icon-white"></i>下载该文档</a></p>';
                      echo '<h4>QC七大手法（传统版）</h4>';
                      echo '<p></p>';
                      echo '</div>';
                      echo '</div>';
                    }
